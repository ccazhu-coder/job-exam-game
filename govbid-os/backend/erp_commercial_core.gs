...
const ERP_TABLES = {
  tenants: ['tenantId','orgName','ownerName','ownerEmail','plan','status','createdAt','updatedAt'],
  users: ['userId','tenantId','userName','email','role','status','lastLoginAt','createdAt','updatedAt'],
  resource_types: ['typeId','tenantId','typeName','parentType','status','createdAt','updatedAt'],
  resources: ['resourceId','tenantId','resourceType','resourceName','specialty','contactName','contactPhone','email','address','taxId','bankInfo','priceNote','status','note','createdAt','updatedAt'],
  projects: ['projectId','tenantId','projectName','projectType','clientName','contractNo','startDate','endDate','budgetAmount','contractAmount','status','description','createdAt','updatedAt'],
  activities: ['activityId','tenantId','projectId','projectName','activityName','activityType','activityDate','startTime','endTime','venueResourceId','venueName','teacherResourceId','teacherName','contactName','contactPhone','host','cohost','status','createdAt','updatedAt'],
  registrations: ['registrationId','tenantId','projectId','activityId','name','phone','email','identity','orgName','source','reviewStatus','attendanceStatus','crmPersonId','createdAt','updatedAt'],
  crm_people: ['crmPersonId','tenantId','name','phone','email','orgName','tags','source','lastActivityId','totalAttendCount','marketingConsent','note','createdAt','updatedAt'],
  activity_tasks: ['taskId','tenantId','projectId','activityId','taskName','taskType','ownerUserId','dueDate','status','completedAt','note','createdAt','updatedAt'],
  receivables: ['receivableId','tenantId','projectId','activityId','targetName','itemName','amount','dueDate','receivedAmount','balance','status','note','createdAt','updatedAt'],
  payments: ['paymentId','tenantId','receivableId','projectId','activityId','amount','paymentDate','paymentMethod','payerName','note','createdAt'],
  expenses: ['expenseId','tenantId','projectId','activityId','expenseDate','expenseType','itemName','amount','vendorResourceId','paymentMethod','receiptStatus','note','createdAt'],
  deliverables: ['deliverableId','tenantId','projectId','activityId','deliverableName','dueDate','status','fileUrl','submittedAt','note','createdAt','updatedAt'],
